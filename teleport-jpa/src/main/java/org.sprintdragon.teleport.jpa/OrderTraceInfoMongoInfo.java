package org.sprintdragon.teleport.jpa;
 ...
 */
@Document(collection = "order_trace_info2")
public class OrderTraceInfoMongoInfo {
    ...
    //财付通支付结果
    private Integer caiFuTongStatus;
    //订单分发到各支付平台状态
    ...
    private String customsregionname; //关区名称

    @Override
    public String toString() {
        return "OrderTraceInfoMongoBean{" +
                "orderId=" + orderId +
                ", venderId=" + venderId +
                ", created=" + created +
                ...
                ", caiFuTongStatus=" + caiFuTongStatus +
                ...
                ", customsregionname='" + customsregionname + '\'' +
                '}';
    }
    ...
    public Integer getCaiFuTongStatus() {
        return caiFuTongStatus;
    }

    public void setCaiFuTongStatus(Integer caiFuTongStatus) {
        this.caiFuTongStatus = caiFuTongStatus;
    }
    ...
    public String getCustomsregionname() {
        return customsregionname;
    }

    public void setCustomsregionname(String customsregionname) {
        this.customsregionname = customsregionname;
    }
}
